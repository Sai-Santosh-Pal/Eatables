...
const circlesData = [
  {
    image: "https://cdn-icons-png.flaticon.com/512/244/244777.png",
    text: "Veg"
  },
  {
    image: "https://i.ibb.co/sp4Pngq/171-1711272-meat-clipart-non-veg-food-non-veg-veg-removebg-preview-1.png",
    text: "Non-Veg"
  }
]
...
export default function FlatListComp({ navigation }) {
  ...
  // const url =
  //   'https://api.spoonacular.com/recipes/complexSearch?apiKey=6f75a5bb81c342e6bdee8526a2482c8d&offset=0&number=100';
      ...
      {loading ? (
        <View style={styles.animationContainer}>
          <LottieView
            ...
            source={{
              uri: 'https://assets2.lottiefiles.com/packages/lf20_dlihd9az.json',
            }}
          />
        </View>
      ) : (
