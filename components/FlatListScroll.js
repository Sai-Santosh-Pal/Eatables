  ...
  return (
    <>
    {
            <ScrollView>
            {
              data.map((dataOfData) => {
                return( 
                  <TouchableOpacity style={{margin: 10, marginBottom: 30, alignItems: 'center', overflow: 'hidden', padding: 10}}>
                    <Image style={{height: 250, width: '100%', borderRadius: 20}} source={{uri: dataOfData.image}} />
                    <Text style={{textAlign: 'center',fontFamily: "sf-pro-medium", margin: 10, fontSize: 14}}>
                      {dataOfData.title}
                    </Text>
                  </TouchableOpacity>
                )
